...
const loadDevotional = async () => {
  try {
    ...
    const storedData = getStoredDevotional();
    ...
    const saved = await getSavedDevotionals();
  ...
  const toggleSave = async () => {
    ...
    try {
      const newSavedState = await toggleSaveDevotional(devotional);
...
${devotional.keyVerse ? `📌 ${devotional.keyVerse.reference} (${version})\n"${devotional.keyVerse.text}"\n` : ''}

${devotional.content?.substring(0, 200)}...

Generated by Bible Devotional AI
      `.trim();
